...
public class DamJdbcQueryParser {
    ...
    public ReferencedSchemaFieldsInfo guessReferencedOutputTableSchemas() {
        ...
        dataFieldsByTable.entrySet().stream().forEach(e -> e.getValue().forEach(c -> fieldsMap.addEntry(e.getKey(), new AbstractMap.SimpleEntry<>(c, null))));
                    ...
                    public void visit(SelectExpressionItem item) {
                        ...
                        if (expr instanceof Column){
                            ...
                            dataFieldsByTable.addEntry(
                              ...
                              new AbstractMap.SimpleEntry<>(DamSchemaUtils.fieldWithMissingInfo(column.getColumnName()), item.getAlias().getName())
                            );
                        }
